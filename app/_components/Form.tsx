      ...
      <div className="rounded-lg border border-accentPink-1">
        ...
        >
          ...
          <textarea
            ...
            name="message"
          />
          <button className="mt-2 w-full self-center rounded-lg bg-accentGreen-1 py-2 text-xl font-bold text-primary-2 shadow-lg transition-all duration-300 hover:bg-accentPink-1">
            Submit
          </button>
        </form>
      </div>
